...
class gps_t(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qdd", self.timestamp, self.alt, self.lat))
    ...
    def _decode_one(buf):
        self = gps_t()
        self.timestamp, self.alt, self.lat = struct.unpack(">qdd", buf.read(24))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if gps_t in parents: return 0
        tmphash = (0xac4ed11d00f5319a) & 0xffffffffffffffff
